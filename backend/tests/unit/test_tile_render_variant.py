...
def test_tile_render_variant_uses_low_zoom_proxy_for_selected_metrics():
    ...
    assert _tile_render_variant("parking", z=6) == "parking_low_zoom_proxy"
    assert _tile_render_variant("land_cover", z=6) == "land_cover_low_zoom_proxy"
...
def test_tile_render_variant_defaults_outside_low_zoom_proxy_mode():
    ...
    assert _tile_render_variant("parking", z=None) == "default"
